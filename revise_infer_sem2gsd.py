...
from model.net2_w_sem2gsd import Net
scale = 384
...
# parser.add_argument("--model_path", type=str, default="./logs/Ver.4.28.net2/60.1_95.6.pth", help='')  #  now sota
# parser.add_argument("--model_path", type=str, default="./logs/Ver.5.1.net2/58.32_95.56.pth", help='')  #  5.3 this paper in net2
parser.add_argument("--model_path", type=str, default="./logs/Ver.net2_w_sem2gsd/glass_max.pth", help='')  #  now sota

parser.add_argument("--result_path", type=str, default="./revision_results/net2_sem2gsd", help='')
...
def test():
    ...
    with torch.no_grad():
        ...
        for idx, img_name in enumerate(img_list):
            ...
            out_ghost = np.array((to_pil(out_ghost)))
