...
parser.add_argument("--model_path", type=str, default="./logs/table6_wo_encoder_decoder_hh/glass_max.pth", help='')  #  now sota
parser.add_argument("--result_path", type=str, default="./ablation/ab_wo_encoder_decoder_find_best_glass_hh", help='')
...
def _test():
    ...
    with torch.no_grad():
        start = time.time()
        # img_list = [img_name for img_name in os.listdir(opt.data_path)]
