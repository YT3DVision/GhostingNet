...
# from model.net2_deform2conv import Net
...
# parser.add_argument("--save_path", type=str, default="./logs/Ver.replace_Deform_w_conv", help='')  # 88.95
parser.add_argument("--save_path", type=str, default="./Run/test_env_net_z2", help='')  # 88.95
...
for epoch in range(opt.epochs):
    ...
    for idx, (input_data, glass, ghost, r1, r2, h, w, with_shift) in enumerate(tqdm(loader_train), 0):
