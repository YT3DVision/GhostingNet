...
parser.add_argument("--model_path", type=str, default="./logs/Ver.net2_wo_feedback--3/56.93.pth", help='')  #  now sota

parser.add_argument("--result_path", type=str, default="./revision_results/net2_wo_feedback", help='')
