...
parser.add_argument("--result_path", type=str, default="./result/Ver0.4.18.mix", help='')
...
def test():
    ...
    state_dict = torch.load('/data/Nips/Ver1.1/logs/Ver4.7/glass_max.pth')
