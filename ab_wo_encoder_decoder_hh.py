...
logging.basicConfig(level=logging.INFO, filename="./log_ab_wo_encoder_decoder_hh.txt", filemode="a",
...
def train():
    ...
    parser.add_argument("--data_path", type=str,
                        ...
                        help='')
    parser.add_argument("--save_path", type=str, default="./logs/table6_wo_encoder_decoder_hh", help='')  # 88.95
