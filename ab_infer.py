...
parser.add_argument("--data_path", type=str, default="/data/dataSet/GEGD871/test/image", help='')
...
parser.add_argument("--model_path", type=str, default="./contrast/GEGD_wo_GED_CASCADE/glass_maxep60.pth", help='')  #  now sota
parser.add_argument("--result_path", type=str, default="./contrast/TPAMI/WO_GED_WO_CASCADE2", help='')
...
ghost_path = os.path.join(opt.result_path, 'glass')
...
def test():
    ...
    with torch.no_grad():
        ...
        for idx, img_name in enumerate(img_list):
            ...
            out_ghost = final_glass.squeeze(0).cpu()
