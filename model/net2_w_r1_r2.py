...
#                    new_state_dict[k] = v
#            print("---start load pretrained modle of swin encoder---")
#            SEM_Net_demo.load_state_di
        
        self.ged_down3 = nn.Conv2d(1024 * 2, 1024, 1, 1, 0)
        self.ged_down2 = nn.Conv2d(512 * 2, 512, 1, 1, 0)
        self.ged_down1 = nn.Conv2d(256 * 2, 256, 1, 1, 0)
        self.ged_down0 = nn.Conv2d(128 * 2, 128, 1, 1, 0)
