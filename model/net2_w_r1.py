...
#            SEM_Net_demo.load_state_dict(new_state_dict, strict=False)
        ...
        self.ged_down3 = nn.Conv2d(1024, 1024, 1, 1, 0)
        self.ged_down2 = nn.Conv2d(512, 512, 1, 1, 0)
        self.ged_down1 = nn.Conv2d(256, 256, 1, 1, 0)
        self.ged_down0 = nn.Conv2d(128, 128, 1, 1, 0)
    ...
    def forward(self, x):
        ...
        layer3_f = ged_layer3
        layer3_f, r1_3 = self.GDM3(layer3_f)
        layer3_f = self.ged_down3(layer3_f)
        p32 = self.ged_up_32(layer3_f)

        layer2_f = p32 + ged_layer2
        layer2_f, r1_2 = self.GDM2(layer2_f)
        layer2_f = self.ged_down2(layer2_f)
        p21 = self.ged_up_21(layer2_f)

        layer1_f = p21 + ged_layer1
        layer1_f, r1_1 = self.GDM1(layer1_f)
        layer1_f = self.ged_down1(layer1_f)
        p10 = self.ged_up_10(layer1_f)

        layer0_f = p10 + ged_layer0
        layer0_f, r1_0 = self.GDM0(layer0_f)
        layer0_f = self.ged_down0(layer0_f)
