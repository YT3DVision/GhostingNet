...
parser.add_argument("--save_path", type=str, default="./logs/Ver4.22_shift2", help='')  # 88.95
...
for epoch in range(opt.epochs):
    ...
    for idx, (input_data, glass, ghost, r1, r2, h, w, with_shift) in enumerate(loader_train, 0):
        ...
        loss = lossR1 + lossR2 + lossGhost + 0.1 * lossPer + 0.1 * lossW + 0.1 *  lossH
        loss.backward()
