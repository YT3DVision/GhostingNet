...
parser.add_argument("--save_path", type=str, default="./logs/ged_wo_cascade5e-5", help='') 
...
loader_train = DataLoader(dataset=dataset_train, num_workers=2, batch_size=opt.batchSize, shuffle=True, drop_last=True)
