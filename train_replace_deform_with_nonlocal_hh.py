...
from model.net2_replace_deform_with_nonlocal_hh import Net
...
logging.basicConfig(level=logging.INFO, filename="./log_replace_deform_with_nonlocal_hh.txt", filemode="a",
...
def train():
    ...
    parser.add_argument("--data_path", type=str,
                        ...
                        help='')
    parser.add_argument("--save_path", type=str, default="./logs/table6_replace_deform_with_nonlocal_hh", help='')
