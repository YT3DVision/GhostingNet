...
parser.add_argument("--save_path", type=str, default="./logs/Ver.net2_w_sem2gsd2", help='')  # 88.95
...
for epoch in range(opt.epochs):
    ...
    for idx, (input_data, glass, ghost, r1, r2, h, w, with_shift) in enumerate(loader_train, 0):
        ...
        lossH = shift_loss(h3, h2, h1, h0, fh, h, with_shift)
        
        lossW = shift_loss(w3, w2, w1, w0, fw, w, with_shift)
