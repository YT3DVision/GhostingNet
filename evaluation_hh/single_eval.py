...
item = "glass"
gt_dir = os.path.join(r"E:\PycharmProjects\NFGlassNet\dataset\test\mask")
pred_dir = os.path.join(r"E:\PycharmProjects\NFGlassNet\pred\glass_pred_CFSwinformer_0830")
