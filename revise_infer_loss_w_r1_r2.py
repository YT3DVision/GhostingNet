...
parser.add_argument("--model_path", type=str, default="./logs/table7_gm_r1_r2_hh/glass_max.pth", help='')  #  now sota
parser.add_argument("--result_path", type=str, default="./ablation/ab_gm_r1_r2_hh", help='')
