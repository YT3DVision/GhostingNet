...
parser.add_argument("--model_path", type=str, default=r"E:\PycharmProjects\GhosetNetV3\logs\table6_ged_wo_cascade_hh_5e-5\train_min.pth", help='')  #  now sota
parser.add_argument("--result_path", type=str, default="./ablation/ab_wo_cascade_hh", help='')
...
def _test():
    ...
    with torch.no_grad():
        ...
        for idx, img_name in enumerate(img_list):
            ...
            h0, w0, per0, r1_0, r2_0, g0 = model(img_var)
