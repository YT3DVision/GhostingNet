...
parser.add_argument("--model_path", type=str, default="./logs/Ver4.21_shift2/train_min.pth", help='')  #  now sota
parser.add_argument("--result_path", type=str, default="./result/Ver0.4.21.mix", help='')
