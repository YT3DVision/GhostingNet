...
logging.basicConfig(level=logging.INFO, filename="./log_ab_wo_feedback_hh.txt", filemode="a",
...
def train():
    ...
    parser.add_argument("--data_path", type=str,
                        ...
                        help='')    # parser.add_argument("--model_path", type=str, default="./logs/Ver.4.27.net2/", help='')  # net
    # parser.add_argument("--save_path", type=str, default="./logs/Ver.7.11.net2.Results", help='')
    # parser.add_argument("--model_path", type=str, default="./logs/Ver.net2_wo_feedback--4.2/ghost_max.pth", help='')  # 88.95
    parser.add_argument("--save_path", type=str, default="./logs/table6_wo_feedback_hh", help='')
