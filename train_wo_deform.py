...
from model.net2_wo_deform import Net
...
parser.add_argument("--save_path", type=str, default="./logs/Ver.net_wo_Deform", help='')  # 88.95
...
for epoch in range(opt.epochs):
    ...
    for idx, (input_data, glass, ghost, r1, r2, h, w, with_shift) in enumerate(loader_train, 0):
        ...
        loss = lossR1 + lossR2 + 2 * lossGlass + 4 * lossGhost + 0.1 * lossW + 0.1 * lossH
        loss.backward()
