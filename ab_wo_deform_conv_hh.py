...
logging.basicConfig(level=logging.INFO, filename="./log_ab_wo_deform_conv_hh.txt", filemode="a",
...
def train():
    ...
    parser.add_argument("--data_path", type=str,
                        ...
                        help='')
    parser.add_argument("--save_path", type=str, default="./logs/table6_wo_deform_conv_hh", help='')  # 88.95
