...
parser.add_argument("--model_path", type=str, default="./logs/table6_replace_deform_conv_by_stand_conv_hh/ghost_max.pth", help='')  #  now sota 57.44_94.85

parser.add_argument("--result_path", type=str, default="./ablation/ab_replace_deform_conv_by_stand_conv_hh", help='')
