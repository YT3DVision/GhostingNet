...
parser.add_argument("--save_path", type=str, default="./logs/Ver.net2_replace_Deform_w_conv", help='')  
# parser.add_argument("--save_path", type=str, default="./logs/Ver.replace_Deform_w_conv", help='')  
